...
image:https://img.shields.io/badge/Revved%20up%20by-Develocity-06A0CE?logo=Gradle&labelColor=02303A[link="https://ge.solutions-team.gradle.com/scans?search.rootProjectNames=JJWT",title="Revved up by Develocity"]
